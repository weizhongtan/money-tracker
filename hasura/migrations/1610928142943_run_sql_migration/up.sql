CREATE OR REPLACE FUNCTION public.func_cumulative_amount(v_account_id uuid, v_group_by text, v_start_date timestamp with time zone, v_end_date timestamp with time zone)
 RETURNS SETOF table_cumulative_amount
 LANGUAGE sql
 STABLE
