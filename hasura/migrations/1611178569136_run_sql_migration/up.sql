CREATE OR REPLACE FUNCTION public.func_category_breakdown(v_start_date timestamp with time zone, v_end_date timestamp with time zone, v_category_type text, v_group_categories boolean, v_account_id uuid)
